...
color:${c};
    ...
    ytpSetI.innerHTML += `<br><b style='font-size:18px' >Protube Settings</b>
...
<br>
<button onclick="Android.oplink('https://github.com/am-abdulmueed/protube/issues')">Report Bugs
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="${isD ? "#ccc" : "#444"}" viewBox="0 0 16 16">
<path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708"/>
</svg>
</button>
<br>
<button style="font-weight:bolder;" onclick="Android.share('Protube 100% free without any ads (a very very light weight app less then 2mb) : https://am-abdulmueed.vercel.app/download');">Share Protube
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="${isD ? "#ccc" : "#444"}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
Latest Version ${YTProVer} of Protube is available , update the Protube to get latest features.
...
- for the full list <u onclick="Android.oplink('https://github.com/am-abdulmueed/protube/releases');" >click here</u>
<br>
<br>
...
<button style="border:0;border-radius:10px;height:30px;width:150px;background:rgba(255,50,50,.7);float:right;" onclick="Android.downvid('Protube.zip','https://nightly.link/am-abdulmueed/protube/workflows/gradle/main/Protube.zip','application/zip');">Download</button>
</div>
