...
public class ForegroundService extends Service {
    ...
    public void updateNotification(String icon, String title, String subtitle, String action, long duration,
        ...
        builder.setSmallIcon(
                (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) ? R.drawable.notification : R.mipmap.app_icon)
    ...
    private void updatePlaybackState(long currentPosition, int state) {
        ...
        // rn it doesn't have a function to increase the playback speed if someone
        // increases it from the youtube player , cuz people don't usually use that ,
        // and i am too lazy to implement it here
